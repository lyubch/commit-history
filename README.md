...
1. Create local configs file
   ...
   ```
2. Change into `main.local.php` the string `<bitbucket-username>` to your Bitbucket login
3. Change into `main.local.php` the string `<bitbucket-password>` to your Bitbucket password
